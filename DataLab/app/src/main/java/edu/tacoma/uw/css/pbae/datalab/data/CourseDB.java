package edu.tacoma.uw.css.pbae.datalab.data;
...
import edu.tacoma.uw.css.pbae.datalab.courses.Course;
...
public class CourseDB {
    ...
    public boolean updateCourse(String id, String shortDesc, String longDesc, String prereqs) {
        ...
        contentValues.put("longDesc", longDesc);
        contentValues.put("prereqs", prereqs);
        int updated = mSQLiteDatabase.update("Course",contentValues,"id=?", new String[]{id});
        return updated == 1;
    }
